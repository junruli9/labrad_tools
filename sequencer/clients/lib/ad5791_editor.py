...
class AD5791VoltageEditor(QtGui.QDialog):
    sequence_parameters = {}
    def __init__(self, channel, sequence, config, reactor=None, cxn=None, parent=None):
        super(AD5791VoltageEditor, self).__init__(parent)
...
if __name__ == '__main__':
    ...
    widget = AD5791VoltageEditor('a', sequence, RampMaker, FakeConfig(), reactor)
    widget.show()
    reactor.run()
